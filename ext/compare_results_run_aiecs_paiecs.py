...
def compare_results():
    tests_base_name = "out_paiecs/4/64/"

    better_run_in_cs = 0
    better_aiecs_in_cs = 0
    better_p_aiecs_in_cs = 0

    better_run_in_m = 0
    better_aiecs_in_m = 0
    better_p_aiecs_in_m = 0
    ...
    for i in range(number_of_tests):
        ...
        try:
            ...
            if scheduler_produced_context_switch_number_aiecs < scheduler_produced_context_switch_number_run and \
                    scheduler_produced_context_switch_number_aiecs < \
                    scheduler_produced_context_switch_number_semipartitionedaiecs:
                better_aiecs_in_cs += 1

            elif scheduler_produced_context_switch_number_run < scheduler_produced_context_switch_number_aiecs and \
                    scheduler_produced_context_switch_number_run < \
                    scheduler_produced_context_switch_number_semipartitionedaiecs:
                better_run_in_cs += 1

            elif scheduler_produced_context_switch_number_semipartitionedaiecs < \
                    scheduler_produced_context_switch_number_run and \
                    scheduler_produced_context_switch_number_semipartitionedaiecs < \
                    scheduler_produced_context_switch_number_aiecs:
                better_p_aiecs_in_cs += 1

            elif scheduler_produced_context_switch_number_semipartitionedaiecs == \
                    scheduler_produced_context_switch_number_run and \
                    scheduler_produced_context_switch_number_run < scheduler_produced_context_switch_number_aiecs:
                better_run_in_cs += 1
                better_p_aiecs_in_cs += 1

            elif scheduler_produced_context_switch_number_semipartitionedaiecs == \
                    scheduler_produced_context_switch_number_aiecs and \
                    scheduler_produced_context_switch_number_aiecs < scheduler_produced_context_switch_number_run:
                better_aiecs_in_cs += 1
                better_p_aiecs_in_cs += 1

            elif scheduler_produced_context_switch_number_run == \
                    scheduler_produced_context_switch_number_aiecs and \
                    scheduler_produced_context_switch_number_aiecs < \
                    scheduler_produced_context_switch_number_semipartitionedaiecs:
                better_run_in_cs += 1
            ...
            if migrations_number_aiecs < migrations_number_run and \
                    migrations_number_aiecs < \
                    migrations_number_semipartitionedaiecs:
                better_aiecs_in_m += 1

            elif migrations_number_run < migrations_number_aiecs and \
                    migrations_number_run < \
                    migrations_number_semipartitionedaiecs:
                better_run_in_m += 1

            elif migrations_number_semipartitionedaiecs < \
                    migrations_number_run and \
                    migrations_number_semipartitionedaiecs < \
                    migrations_number_aiecs:
                better_p_aiecs_in_m += 1

            elif migrations_number_semipartitionedaiecs == \
                    migrations_number_run and \
                    migrations_number_run < migrations_number_aiecs:
                better_run_in_m += 1
                better_p_aiecs_in_m += 1

            elif migrations_number_semipartitionedaiecs == \
                    migrations_number_aiecs and \
                    migrations_number_aiecs < migrations_number_run:
                better_aiecs_in_m += 1
                better_p_aiecs_in_m += 1

            elif migrations_number_run == \
                    migrations_number_aiecs and \
                    migrations_number_aiecs < \
                    migrations_number_semipartitionedaiecs:
                better_run_in_m += 1
    ...
    print("Better P_AIECS in context switch", better_p_aiecs_in_cs)

    print("Better RUN in migrations", better_run_in_m)
    print("Better AIECS in migrations", better_aiecs_in_m)
    print("Better P_AIECS in migrations", better_p_aiecs_in_m)
