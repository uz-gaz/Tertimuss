...
def rec_comparision(experiment_name: str, number_of_cpus: int, number_of_tasks: int,
    ...
    # Fixed aperiodic task
    aperiodic_task = AperiodicTask(1 * 1000, 10, 20, 20)

    # Fixed run polling server
    run_polling_server_task = PeriodicTask(2 * 1000, 10, 10, None)
    run_polling_server_task_utilization = (run_polling_server_task.c / 1000) / run_polling_server_task.d
    ...
    x = u.generate(
        {
            ...
            "utilization": number_of_cpus - run_polling_server_task_utilization,
    ...
    # Append aperiodic task
    x.append(aperiodic_task)
    tasks_definition_dict.append({
        "type": "Aperiodic",
        "worst_case_execution_time": aperiodic_task.c,
        "arrive": aperiodic_task.a,
        "deadline": aperiodic_task.d
    })
    ...
    schedulers = [
        ...
        (RUNAScheduler(run_polling_server_task), "run"),
    ]
