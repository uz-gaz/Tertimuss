...
from main.core.tcpn_simulator.implementation.TcpnSimulatorAccurateOptimizedTasks import TcpnSimulatorAccurateOptimizedTasks
from main.core.tcpn_simulator.TcpnSimulatorAccurateOptimizedThermalOld import TcpnSimulatorAccurateOptimizedThermalOld


class GlobalModelSolverOld(object):
    def __init__(self, global_model: GlobalModel, global_specification: GlobalSpecification):
        ...
        if global_model.enable_thermal_mode:
            self.__tcpn_simulator_thermal = TcpnSimulatorAccurateOptimizedThermalOld(global_model.pre_thermal,
