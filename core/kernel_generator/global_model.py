...
def generate_global_model(tasks_model: TasksModel, processor_model: ProcessorModel,
    ...
    b = scipy.concatenate((tasks_model.c_tau_alloc, processor_model.c_proc_alloc, thermal_model.ct_exec), axis=0)
    ...
    s = scipy.concatenate((processor_model.s_busy, processor_model.s_exec), axis=0)
    ...
    mo = scipy.concatenate((tasks_model.m_tau_o, processor_model.m_proc_o, mo), axis=0)
